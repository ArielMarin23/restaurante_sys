$(document).ready(function () {
  ...
  $(".eliminar-btn").click(function (event) {
    event.preventDefault(event); // Evita que el enlace navegue
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire("Cancelado", "La ciudad no fue borrada.", "info");
      }
    });
  });
});
...
function cargarDatosSelects() {
  $.getJSON("/cliente/datos_formulario", function (data) {
    ...
    $.each(data.nacionalidades, function (index, nacionalidad) {
      nacionalidadesSelect.append(
        new Option(nacionalidad.descrip_nac, nacionalidad.cod_nac)
      );
    });
    ...
    $.each(data.tipos_documentos, function (index, tipo_documento) {
      tiposDocumentosSelect.append(
        new Option(tipo_documento.descrip_tip_doc, tipo_documento.cod_tip_doc)
      );
    });
  });
}
function actualizarCliente() {
  ...
  $("#enviar").on("click", function (e) {
    ...
    $.ajax({
      url: "/cliente/update-cliente", // URL a la que enviar los datos
      method: "POST",
...
function agregarCliente() {
  ...
  $("#enviar").on("click", function (e) {
    ...
    $.ajax({
      url: "/cliente/saved-cliente", // Asegúrate de que esta ruta exista en Flask
      type: "POST",
      contentType: "application/json",
